...
contains
  ...
  subroutine trace_IO(rank,subs_list,time_list,call_list)
    ...
    open(unit=file_id,file="profile."//rank_char//".n_body",RECL=8192,form="FORMATTED",status="UNKNOWN")

    write(file_id,*)    '+==============================================================================================+'
    write(file_id,*)    '|                       .                        ___                                           |'
    write(file_id,*)    '|           .                      *          ,o88888                               *          |'
    write(file_id,*)    '|                                          ,o8888888"           .                              |'
    write(file_id,*)    '|  o                 ,:o:o:oooo.        ,8O88Pd8888"                                           |'
    write(file_id,*)    '|                ,.::.::o:ooooOoOoO. ,oO8O8Pd888""                       *                     |'
    write(file_id,*)    '|       *      ,.:.::o:ooOoOoOO8O8OOo.8OOPd8O8O"                                      .        |'
    write(file_id,*)    '|             , ..:.::o:ooOoOOOO8OOOOo.FdO8O8"          *                     o                |'
    write(file_id,*)    '|            , ..:.::o:ooOoOO8O888O8O,COCOO"                                                   |'
    write(file_id,*)    '|           , . ..:.::o:ooOoOOOO8OOOOCOCO"                                                     |'
    write(file_id,*)    '|    *      . ..:.::o:ooOoOoOO8O8OCCCC"o          88b 88       88""Yb  dP"Yb  8888b.  Yb  dP   |'
    write(file_id,*)    '|              . ..:.::o:ooooOoCoCCC"o:o          88Yb88       88__dP dP   Yb  8I  Yb  YbdP    |'
    write(file_id,*)    '|              . ..:.::o:o:,cooooCo"oo:o:         88 Y88       88""Yb Yb   dP  8I  dY   8P     |'
    write(file_id,*)    '|           `   . . ..:.:cocoooo""o:o:::"         88  Y8 ooooo 88oodP  YbodP  8888Y"   dP      |'
    write(file_id,*)    '|  o        .`   . ..::ccccoc""o:o:o:::"                                                       |'
    write(file_id,*)    '|          :.:.    ,c:cccc"":.:.:.:.:."                                   .                    |'
    write(file_id,*)    '|        ..:.:""`::::c:""..:.:.:.:.:."        o         .                                *     |'
    write(file_id,*)    '|      ...:.".:.::::""    . . . . ."                                                           |'
    write(file_id,*)    '|     .. . ....:."" `   .  . . ""                              .                   |           |'
    write(file_id,*)    '|   . . . ....""                     o                                            -O-      .   |'
    ...
    write(file_id,*)    '|                            .                                                                 |'
    write(file_id,*)    '+----------------------------------------------------------------------------------------------+'
    write(file_id,*)    '|           N_BODY v.1.0. Z.Hawkhead                                                           |'
    write(file_id,*)    '+==============================================================================================+'
    write(file_id,*)    '|                                                                                              |'
